...
Do not perform Scout, Analyst, Editor, Auditor, or Formatter work in the main
conversation. For role-owned artifact work, explicitly invoke the matching
project CodeBuddy sub-agent:
