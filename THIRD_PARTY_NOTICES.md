...
- WikiSkill（Stahl-G/wikiskill，9df975b）：MIT，源码在独立 WikiSkill 仓库维护；BriefLoop 的 vendor/wheels 提供其已构建 wheel 并自动安装，用户无需第二次 clone。版本 0.1.1+briefloop.1，完整许可包含在 wheel metadata。
