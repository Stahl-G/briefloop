...
- Audit warnings, overstatement findings, support-calibration findings, and quality-gate findings do not authorize direct edits to frozen artifacts. Route current-gate owner-stage repair through `gates show` required_commands and scoped repair start, or choose request_human_review or block_run when no deterministic route exists.
