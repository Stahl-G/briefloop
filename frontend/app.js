...
function syncFactCheckControl(){const box=$('requirements').elements.fact_check;box.disabled=!$('requirements').elements.allow_web.checked;if(box.disabled)box.checked=false}
