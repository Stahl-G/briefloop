...
function reportOutline(){return outlineHeadings()}
...
function renderOutline(){
 const box=$('report-outline');if(!box)return;const items=outlineHeadings();const text=items.map(h=>'#'.repeat(h.level)+' '+h.text).join('\n');
