...
const descriptions = {
 ...
 'codebuddy': '腾讯 CodeBuddy 命令行 Agent',
 'hermes': '通过 ACP 连接的命令行 Agent',
 'kimi': 'Moonshot AI 的 Kimi 命令行 Agent',
 'mimo': '小米 MiMo 命令行 Agent',
 'reasonix': 'DeepSeek 命令行 Agent',
 'aider': '终端中的 AI 编程助手',
 'amp': '命令行编程 Agent',
 ...
 'deepseek-harness': 'DeepSeek 命令行运行时',
 'deepseek': 'DeepSeek 终端交互界面',
 'devin': 'Cognition 的终端编程 Agent',
 'grok-build': 'Grok 命令行编程工具',
 'kilo': 'Kilo Code 命令行 Agent',
 'kiro': 'Kiro 命令行 Agent',
 'pi': '命令行编程 Agent',
 'qoder': 'Qoder 命令行 Agent',
 'qwen': 'Qwen 命令行编程 Agent',
 'trae-cli': 'Trae 的命令行 Agent',
 'vibe': 'Mistral 开源命令行 Agent',
 'zcode': '智谱开源的命令行 Agent',
};
