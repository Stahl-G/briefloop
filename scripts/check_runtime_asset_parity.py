...
REQUIRED_SOURCE_ASSETS = [
    ...
    "integrations/workbuddy/briefloop/references/quickstart.md",
    "integrations/workbuddy/briefloop/references/workspace-workflow.md",
    "integrations/workbuddy/briefloop/references/artifact-boundary.md",
