...
REQUIRED_DOC_BOUNDARY_PHRASES = {
    "README.md": [
        ...
        "v0.15.1 engineering target, included in v0.15.3",
        "solar-stock-periodic",
        "v0.15.3 successor path",
    ],
    "README_en.md": [
...
REQUIRED_FIRST_USER_DOC_PHRASES = {
    ...
    "docs/weekly-loop.md": [
        ...
        "briefloop quality laj review-open",
        "There is no supported standalone `briefloop deliver`",
    ],
...
REQUIRED_GOLDEN_PATH_PHRASES = {
    "docs/golden-path.md": [
        ...
        "document-review",
        "solar-stock-periodic",
        "wider legacy `solar-periodic` Product OS",
