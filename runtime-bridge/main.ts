...
function capabilities(id:string){const p=protocol(id);return {chat:!!p,cancel:!!p,resume:p==='acp'?'negotiated':p==='claude-stream-json'||p==='opencode-json'||p==='antigravity-stream-json'||p==='pi-rpc',images:p==='acp'?'negotiated':p==='claude-stream-json',questions:p==='acp'||p==='pi-rpc',steer:false,read_only:false,network_control:false,permission_modes:['runtime-native']};}
