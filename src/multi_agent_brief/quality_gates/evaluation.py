"""Deterministic quality-gate evaluation from detached trusted values.

Single source for the gate evaluation closure (LD2-2b relocation). This module
performs no workspace reads or writes and must not import the runtime_state
stack; the workspace-bound gate commands remain in
:mod:`multi_agent_brief.quality_gates.state` until LD2-3.
"""
...
from multi_agent_brief.contracts.runtime_errors import RuntimeStateError
