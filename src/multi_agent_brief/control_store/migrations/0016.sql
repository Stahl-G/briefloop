...
-- Fresh-schema v0.15 Reader Review profile expansion.  This migration is
-- deliberately not an upgrade path: the runtime rejects v15 Stores before
-- applying migrations.  It only makes the new, empty v16 schema admit the
-- Chinese industry-weekly Reader Review profile alongside the original
-- English management-monthly profile.
...
RENAME TO post_final_assessment_policy_revisions_v15;
ALTER TABLE post_final_assessment_requests
RENAME TO post_final_assessment_requests_v15;
ALTER TABLE post_final_assessment_results
RENAME TO post_final_assessment_results_v15;
...
CREATE TABLE post_final_assessment_policy_revisions (
    ...
    CHECK(
        ...
        (schema_version='briefloop.post_final_assessment_policy_revision.v3'
         AND profile_id IN ('management_brief_en_v1','industry_weekly_zh_v1')
...
SELECT * FROM post_final_assessment_policy_revisions_v15;
INSERT INTO post_final_assessment_requests
SELECT * FROM post_final_assessment_requests_v15;
INSERT INTO post_final_assessment_results
SELECT * FROM post_final_assessment_results_v15;

DROP TABLE post_final_assessment_results_v15;
DROP TABLE post_final_assessment_requests_v15;
DROP TABLE post_final_assessment_policy_revisions_v15;
...
INSERT INTO schema_migrations(version,name) VALUES(16,'0016');
