...
def register(sub):
    ...
    start.add_argument('--agent-runtime',help='Require fresh native subagent submissions from this host (recommended: codex, claude-code; others allowed)')
    ...
    dispatch.add_argument('--runtime',required=True,help='Host that starts fresh subagents (recommended: codex, claude-code; others allowed)')
    ...
    bind.add_argument('--agent-id',required=True);bind.add_argument('--runtime',required=True,help='Host that starts fresh subagents (recommended: codex, claude-code; others allowed)')
