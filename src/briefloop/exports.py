...
def docx_bytes(markdown='', *, report_profile="brief", title="", report_date="", organization="", period="", report_data=None, industry="", figures=None, document=None, source_records=None, language=None, citations=None):
