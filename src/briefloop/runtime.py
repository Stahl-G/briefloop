...
def generation_prompt(store, run, folder, backend='codex'):
    ...
    if research_plan:
        # The plan may request fewer Scouts than the frozen host ceiling.
