...
const {section}=await import('./tests/source_section.mjs');
const app=readFileSync('frontend/app.js','utf8');
const mapping=section(app,'// BEGIN_FIGURE_EDITOR_MAPPING','// END_FIGURE_EDITOR_MAPPING','frontend/app.js').split('\n').slice(1).join('\n');
