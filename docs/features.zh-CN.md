...
当前产品基线：**v0.12.1 支持的 baseline 入口：`industry-weekly`、
...
| Runtime handoff | 为外部 orchestrator 和 subagents 生成执行交接面 | 默认在场 | `multi-agent-brief run --workspace <workspace> --runtime operator` |
